...
keymap.set("n", "<leader>bg", themeSwitcher.toggleBackground, { desc = "Toggle background (light/dark)" })
keymap.set("n", "<leader>th", themeSwitcher.themePickerWithPreview, { desc = "Theme switcher (with preview)" })
...
end, { desc = "Toggle split layout vertical/horizontal" })
